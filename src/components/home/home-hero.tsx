...
export function HomeHero() {
  return (
    <section className="relative isolate min-h-[clamp(38rem,72vh,52rem)] overflow-hidden bg-dark-section text-dark-foreground">
      ...
      <div
        className="absolute inset-y-0 right-0 -z-30 w-full bg-stone/10 lg:w-[58%]"
        aria-hidden="true"
      />
      <HeritagePattern className="absolute right-[-8rem] bottom-14 -z-10 w-[44rem] opacity-[0.16]" />
      <Container
        className="flex min-h-[clamp(38rem,72vh,52rem)] items-center py-20 sm:py-24"
        wide
      >
        <div className="reveal max-w-4xl">
          <p className="text-eyebrow text-antique-gold">
            Bakının yaddaşından doğan niş ətirlər
          </p>
          ...
          <p className="mt-8 max-w-2xl text-base leading-8 text-stone sm:text-lg">
            Useynkhan1792 Bakı tarixinin, Xəzər nəfəsinin və müasir niş
            parfümeriyanın bir araya gəldiyi ətir kolleksiyasıdır.
          </p>
          <div className="mt-10 flex flex-col gap-3 sm:flex-row">
            ...
            <LinkButton
              ...
              variant="outline"
              size="lg"
              className="border-stone/50 text-dark-foreground hover:border-dark-foreground"
            >
              Hekayəmizi oxu
            </LinkButton>
          </div>
