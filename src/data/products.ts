...
export const products = [
  {
    ...
    images: [productPlaceholder("Baku Nights ətir təqdimatı")],
    featured: true,
    bestseller: true,
    status: "active",
    stockQuantity: null,
  ...
  },
  {
    ...
    images: [productPlaceholder("Black Town ətir təqdimatı")],
    featured: true,
    bestseller: false,
    status: "active",
    stockQuantity: null,
  ...
  },
  {
    ...
    images: [productPlaceholder("Caspian Wave ətir təqdimatı")],
    featured: true,
    bestseller: true,
    status: "active",
    stockQuantity: null,
  ...
  },
  {
    ...
    images: [productPlaceholder("King’s Town ətir təqdimatı")],
    featured: true,
    bestseller: false,
    status: "active",
    stockQuantity: null,
  ...
  },
  {
    ...
    images: [productPlaceholder("Four Scents of Baku kəşf dəsti təqdimatı")],
    featured: true,
    bestseller: true,
    status: "active",
    stockQuantity: null,
