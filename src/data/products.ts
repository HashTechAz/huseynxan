...
export const products = [
  ...
  },
  {
    ...
    images: [
      ...
      {
        src: "/images/products/baku-nights/baku-nights-profile.webp",
        fallbackSrc: PRODUCT_PLACEHOLDER,
        alt: "Baku Nights ətir flakonu isti Bakı daşı fonunda",
        width: 1086,
        height: 1448,
        available: true,
      },
      {
        src: "/images/products/black-town/black-town-profile.webp",
        fallbackSrc: PRODUCT_PLACEHOLDER,
        alt: "Black Town ətir flakonu isti Bakı daşı fonunda",
        width: 1086,
        height: 1448,
        available: true,
      },
      {
        src: "/images/products/caspian-wave/caspian-wave-profile.webp",
        fallbackSrc: PRODUCT_PLACEHOLDER,
        alt: "Caspian Wave ətir flakonu isti Bakı daşı fonunda",
        width: 1086,
        height: 1448,
        available: true,
      },
      {
        src: "/images/products/kings-town/kings-town-profile.webp",
        fallbackSrc: PRODUCT_PLACEHOLDER,
        alt: "King’s Town ətir flakonu isti Bakı daşı fonunda",
        width: 1086,
        height: 1448,
        available: true,
      },
